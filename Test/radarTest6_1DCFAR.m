...
for i = 1:(Ns-(G+T+1))     
    ...
    signal = X_cfar(i+T+G);
    if(signal > threshold_cfar(i))
        signal_cfar_f(i) = signal;
    end
...
hold on
plot (circshift(signal_cfar_f,(T+G)),'g--','LineWidth',2);
