...
for i = Tr+Gr+1 : Nr/2-(Gr+Tr)
    for j = Td+Gd+1 : Nd-(Gd+Td)
        ...
        % fprintf("noise_level avg: %f, threshold: %f \n",noise_level / ((2*Tr+2*Gr+1)*(2*Td+2*Gd+1)-(2*Gr+1)*(2*Gd+1)), threshold )
...
% Since the cell under test are not located at the edges, due to the training cells occupying the edges, 
% suppress the edges to zero. Any cell value that is neither 1 nor a 0, assign it a zero.
filteringIdx = (RDM~=0 & RDM~=1);
RDM(filteringIdx) = 0;
